                                    ...
                                    @if($order->shipping_cost != 0)
                                        ...
                                        @if(DB::table('shippings')->where('price','=',$price)->count() > 0)
                                            <tr>
                                                ...
                                                <td width="10%">:</td>
                                                <td width="45%">{{ number_format($order->shipping_cost ,2, '.', '') }} {{$order->currency_sign}}</td>
                                            </tr>
                                        @endif
                                    @endif
                                    @if($order->packing_cost != 0)
                                        ...
                                        @if(DB::table('packages')->where('price','=',$pprice)->count() > 0)
                                            <tr>
                                                ...
                                                <td width="10%">:</td>
                                                <td width="45%">{{ number_format($order->packing_cost,2, '.', '') }} {{$order->currency_sign}}</td>
                                            </tr>
                                        @endif
                                    @endif
                                    <tr>
                                        ...
                                        <td width="10%">:</td>
                                        <td width="45%">{{ number_format($order->pay_amount * $order->currency_value ,2, '.', '') }} {{$order->currency_sign}}</td>
                                    </tr>
                                    <tr>
                                ...
                                @foreach($order->merchantPckages as $package)
                                    ...
                                    @endphp
                                        <tr>
                                            ...
                                            <td><a target="_blank" href="{{route('admin.merchant.show',$package->merchant_id)}}">
                                                {{$user->merchantInformation->shop_name}}
                                            </a>
                                        </td>
                                            <td>{{ $package->delivery_status }}</td>
                                            <td>{{ $productName->productName }} <br>
                                                <small>@if($productName->productColor) Color: {{ $productName->productColor ?? NULL }} @endif</small>
                                            </td>
