        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="product-description">
                    ...
                    <input type="hidden" id="track-store" value="{{route('ebaskat.admin.order.track.store')}}">
                    <form id="trackform" action="{{route('ebaskat.admin.order.track.store')}}" method="POST" enctype="multipart/form-data">
                        {{csrf_field()}}
                        ...
                        <tr data-id="{{ $track->id }}">
                            ...
                            <td>
                                <div class="action-list">
                                    <a data-href="{{ route('ebaskat.admin.order.track.update',$track->id) }}" class="track-edit"> <i class="fas fa-edit"></i>Edit</a>
                                    <a href="javascript:;" data-href="{{ route('ebaskat.admin.order.track.delete',$track->id) }}" class="track-delete"><i class="fas fa-trash-alt"></i></a>
                                </div>
                            </td>
                        </tr>
                        @endforeach
