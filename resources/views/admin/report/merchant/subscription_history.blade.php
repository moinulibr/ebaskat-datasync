...
@section('content')
    ...
    <div class="content-area">
        <div class="mr-breadcrumb">
            <div class="row">
                <div class="col-lg-5">
                    <h4 class="heading">{{ __('Merchant Subscription Plan History') }}</h4>
                    <ul class="links">
                        <li>
                        ...
                        <li>
                            {{ __('Merchant Subscription Plan History') }}
                        </li>
                    </ul>
                </div>
                <div class="col-md-7 mt-3">
                    <div class="btn-group float-right" role="group" aria-label="Order Status">
                        ...
                        <a href="{{ route('admin.report.merchant.subscription_history') }}" class="btn btn-info">Subscription history</a>
...
@push('scripts')
    ...
    <script>
        let table = $('#report_table').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "{{ route('admin.report.merchant.subscription_history') }}",
                data: function(data){
            ...
            buttons: [{
                ...
                titleAttr: 'CSV',
                title: 'Merchant Subscription Report',
            }],
            language: {
