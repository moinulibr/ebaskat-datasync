...
@section('content')
    ...
    <input type="hidden" id="headerdata" value="{{ __('Merchant Order Report') }}">

    <div class="content-area">
        <div class="mr-breadcrumb">
            <div class="row">
                <div class="col-lg-5">
                    <h4 class="heading">{{ __('Merchant Order Report') }}</h4>
                    <ul class="links">
                        <li>
                ...
                <div class="col-md-7 mt-3">
                    <div class="btn-group float-right" role="group" aria-label="Order Status">
                        ...
                        <a href="{{ route('admin.report.merchant.order_report') }}" class="btn btn-info">Order report</a>
                    </div>
                </div>
            </div>
        </div>
...
@push('scripts')
    ...
    <script type="text/javascript">
        let table = $('#report_table').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "{{ route('admin.report.merchant.order_report') }}",
                data: function(data){
