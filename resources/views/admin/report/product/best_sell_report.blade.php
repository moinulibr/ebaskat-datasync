...
@section('content')
    ...
    <input type="hidden" id="headerdata" value="{{ __('Best Sell Product Report') }}">

    <div class="content-area">
        <div class="mr-breadcrumb">
            <div class="row">
                <div class="col-lg-6">
                    <h4 class="heading">{{ __('Best Sell Product Report') }}</h4>
                    <ul class="links">
                        <li>
                ...
                <div class="col-md-6 mt-3">
                    <div class="btn-group float-right" role="group">
                        ...
                        <a href="{{ route('admin.report.product.best-sell') }}" class="btn btn-info">Best sell</a>
                    </div>
                </div>
            </div>
        </div>
...
@push('scripts')
    ...
    <script type="text/javascript">
        ...
        let table = $('#report_table').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "{{ route('admin.report.product.best-sell') }}",
                data: function(data){
