...
@section('content')
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ul class="links">
                        ...
                        <li>
                            <a href="{{ route('admin.product.index') }}">{{ __('Catalog Products') }}</a>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    {{-- DELETE MODAL --}}
    @include('includes.delete-modal', ['type' => 'Catalog Product'])
    {{-- Resote Modal --}}
    @include('includes.restore_modal', ['type' => 'Catalog Product'])
...
@section('scripts')
    ...
    <script type="text/javascript">
        var table = $('#geniustable').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '{{ route('admin.product.catalog.datatables') }}',
            columns: [{
                    data: 'name',
                    name: 'name'
                },
