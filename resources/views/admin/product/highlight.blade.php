								...
								<div class="row">
									<div class="col-lg-12">
										<div class="product-description">
											...
											<form id="geniusformdata" action="{{route('admin.product.feature',$data->id)}}" method="POST" enctype="multipart/form-data">
												{{csrf_field()}}
												...
												<div class="row">
													<div class="col-lg-8">
														<div class="left-area">
																<h4 class="heading">{{ __("Highlight in Best") }} *</h4>
														</div>
													</div>
									                  <div class="col-sm-3">
									                    <label class="switch">
												...
												<div class="row">
													<div class="col-lg-8">
														<div class="left-area">
																<h4 class="heading">{{ __("Highlight in Top") }} *</h4>
														</div>
													</div>
									                  <div class="col-sm-3">
									                    <label class="switch">
												...
												<div class="row">
													<div class="col-lg-8">
														<div class="left-area">
																<h4 class="heading">{{ __("Highlight in Big") }} *</h4>
														</div>
													</div>
									                  <div class="col-sm-3">
									                    <label class="switch">
												...
												<div class="row">
													<div class="col-lg-8">
														<div class="left-area">
																<h4 class="heading">{{ __("Highlight in Discount") }} *</h4>
														</div>
													</div>
									                  <div class="col-sm-3">
									                    <label class="switch">
