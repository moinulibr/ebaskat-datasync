		...
		<div class="row">
			<div class="col-lg-12">
				<h4 class="heading">{{ __('Physical Product ') }} 
					<a class="add-btn float-right btn-sm mt-3"
						href="{{ route('admin.product.index') }}"><i class="fas fa-arrow-left"></i> 
						{{ __('Back') }}
					</a>
					{{-- <a class="add-btn float-right btn-sm mt-3"
						href="{{ route('admin.product.types') }}"><i class="fas fa-arrow-left"></i> 
						{{ __('Back') }}
					</a> --}}
				</h4>
				<ul class="links">
					...
					<li>
						<a href="{{ route('admin.product.physical.create') }}">{{ __('Physical Product') }}</a>
					</li>
				</ul>
			</div>
		</div>
					...
					<div class="product-description">
						<div class="body-area">
							...
							<div class="gocover"
								...
								<div class="row mb-0">
									...
									<div class="col-lg-6">
										...
										<input type="text" class="input-field" placeholder="{{ __('Enter Product Sku') }}"
											name="sku" required=""
											value="{{ Str::random(3).substr(time(), 6,8).Str::random(3) }}"> <br>
								...
								<!-- Product sub-category and child-category -->
								<div class="row mb-0">
									<!-- Sub-category -->
									<div class="col-lg-6">
										<div class="left-area">
								...
								<!-- Allow product condition and estimated shipping time starts -->
								<div class="row mb-0">
									<!-- Product condition -->
									<div class="col-lg-6">
										<div class="row">
								...
								<!-- Allow product condition and estimated shipping time ends -->
												...
												<div class="size-area">
													...
													<div class="row">
														...
														<div class="col-md-4 col-sm-6">
															...
															<input type="number" name="size_qty[]"  step="any" lass="input-field"
														...
														<div class="col-md-4 col-sm-6">
															<label>
																{{ __('Size Price') }} :
																<span>
																	{{ __('(Price will be added with base price)') }}
																</span>
															</label>
															<input type="number" name="size_price[]" step="any" lass="input-field"
								...
								<!-- Allow Product Whole Sell Starts -->
								<div class="row">
									<div class="col-lg-12">
										<div class="left-area">
											...
											<div class="featured-keyword-area">
												<div class="feature-tag-top-filds" id="whole-section">
													<div class="feature-area">
														...
														<div class="row">
															<div class="col-lg-6">
																<input type="number" step="any" name="whole_sell_qty[]"
																	class="input-field"
																	placeholder="{{ __('Enter Quantity') }}" min="0">
															</div>

															<div class="col-lg-6">
																<input type="number" step="any" name="whole_sell_discount[]"
																	class="input-field"
								...
								<!-- Allow Product Whole Sell Ends-->


								<!-- Product stock and measurement starts -->
								<div class="row" id="stckprod">
										...
										<div class="col-lg-12">
											<input name="stock" type="number" step="any" class="input-field"
												placeholder="{{ __('e.g 20') }}">
											<div class="checkbox-wrapper">
												<input type="checkbox" name="measure" class="checkclick"
								...
								<!-- Product stock and measurement ends -->
									...
									<div class="row">
										<div class="col-lg-12">
											<ul class="nav nav-tabs">
												<!-- Product description -->
												<li class="nav-item">
													<a href="#product_description" class="nav-link active" role="tab" data-toggle="tab"><b>Product Description</b></a>
												</li>
												<!-- Product Buy/Return Policy -->
												<li class="nav-item">
													<a href="#product_policy" class="nav-link" role="tab" data-toggle="tab"><b>Product Buy/Return Policy</b></a>
												</li>
											</ul>
											...
											<div class="tab-content">
												...
												<div role="tabpanel" class="tab-pane active" id="product_description">
													...
													<div>
														<textarea  id="ckeditor-one" name="details" rows="6"></textarea>
													</div>
												</div>
												<!-- Product Buy/Return Policy -->
												<div role="tabpanel" class="tab-pane" id="product_policy">
													...
													<div>
														<textarea id="ckeditor-two"  name="policy" rows="6"></textarea>
													</div>
												</div>
											</div>
										</div>
							...
							<div class="body-area">
								...
								<!-- Product previous price -->
									...
									<div class="row">
										...
										<div class="col-lg-12">
											<input name="product_commission" type="number" class="input-field"
												placeholder="{{ __('e.g 20') }}" step="0.01" required="" min="0">
										</div>
									</div>
								...
								<!-- Youtube video url -->
									...
									<div class="row">
										...
										<div class="col-lg-12">
											<select  name="brand_id" required="" class="brand_id">
