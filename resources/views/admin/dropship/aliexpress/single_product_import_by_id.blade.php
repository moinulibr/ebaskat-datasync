			...
			<div class="col-lg-12 p-5">
				<div class="gocover" style="background: url({{asset('assets/images/xloading.gif')}}) no-repeat scroll center center rgba(45, 45, 45, 0.5);"></div>
                        ...
                        <div class="row disabled">
                            <div class="col-lg-12 mt-4 text-center">
                                <button class="mybtn1 mr-5 disabledAttr import" type="submit" >{{ __("Import Product From Aliexpress") }}</button>
                            </div>
                        </div>
...
<input type="hidden" value="{{route('admin.aliexpress.single.product.importing.by.id')}}" class="importingSingleProductByProductIdUrl"/>
@endsection

@section('scripts')
<script src="{{asset('custom_js/dropship/aliexpress-single-product-import.js')}}"></script>
