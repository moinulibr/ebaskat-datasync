...
@section('content')
    ...
    <div class="content-area">
        <div class="mr-breadcrumb">
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="heading">{{ __("Customer Details") }} <a class="add-btn float-right btn-sm mt-3"
                                                                        href="{{ url()->previous() }}"><i
        ...
        <div class="add-product-content1 customar-details-area shadow">
            <div class="row">
                <div class="col-lg-12">
                                ...
                                <div class="col-md-4">
                                    <div class="user-image">
                                        @if($data->is_provider == 1)
                                            <img
                                                src="{{ $data->photo ? asset($data->photo):asset('storage/no-image-found/customer.jpg')}}"
                                                alt="No Image">
                                        @else
                                            <img
                                                src="{{ $data->photo ? asset('storage/users/'.$data->photo):asset('storage/no-image-found/customer.jpg')}}"
                                                alt="No Image">
                                        @endif
                                ...
                                <div class="col-md-4">
                                    <div class="table-responsive show-table">
                                        <table class="table">
                                            ...
                                            <tr>
                                                <th>{{ __("Joined") }}</th>
                                                <td>{{date('Y-m-d h:i:s',strtotime($data->created_at))}}</td> {{-- {{$data->created_at->diffForHumans()}} --}}
                                            </tr>
                                        </table>
                                    </div>
                                </div>
