...
<div class="content-area">
    <div class="mr-breadcrumb">
        <div class="row">
            <div class="col-lg-12">
                    <h4 class="heading">{{ __('Order Shipment - Shipped') }}</h4>
                    <ul class="links">
                        <li>
                            <a href="{{ route('admin.dashboard') }}">{{ __('Dashboard') }} </a>
                        </li>
                        <li>
                            <a href="{{ route('admin.order.shipment.shipped') }}">{{ __('Shipped') }}</a>
                        </li>
                    </ul>
            </div>
        </div>
                    ...
                    <table class="table table-sm">
                        <thead>
                          <tr>
                            ...
                            <th scope="col">Delivery Tracking Code</th>
                        ...
                        @foreach($order_package as $package)
                          <tr>
                            <th scope="row">
                                {{ $package->order_package_number }}
                            </th>
                            <td>
                                {{ $package->merchantInfo->shop_name }}
                            </td>
                            <td>
                                {{ $package->delivery_tracking_code }}
                            </td>
                            <td>
