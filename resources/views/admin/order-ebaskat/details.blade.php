...
@section('content')
    <div class="content-area">
        <div class="mr-breadcrumb">
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="heading">{{ __('Order Details') }}
        ...
        <div class="order-table-wrap shadow">
                ...
                <div class="col-lg-6">
                    <div class="special-box">
                            ...
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td width="10%">:</td>
                                        <td width="45%">{{$order->ebaskatOrderQuantity()}}</td>
                                    </tr>
                                    @if($order->shipping_cost != 0)
                                        ...
                                        @if(DB::table('shippings')->where('price','=',$price)->count() > 0)
                                            <tr>
                                                ...
                                                <td width="10%">:</td>
                                                <td width="45%">€{{ number_format($order->shipping_cost, 2, '.', '') }}</td>
                                            </tr>
                                        @endif
                                    @endif
                                    @if($order->packing_cost != 0)
                                        ...
                                        @if(DB::table('packages')->where('price','=',$pprice)->count() > 0)
                                            <tr>
                                                ...
                                                <td width="10%">:</td>
                                                <td width="45%">€{{ number_format($order->packing_cost, 2, '.', '') }}</td>
                                            </tr>
                                        @endif
                                    @endif
                                    <tr>
                                        ...
                                        <td width="10%">:</td>
                                        <td width="45%">€{{ number_format(($order->ebaskatOrderProductAmount() * $order->currency_value) , 2, '.', '') }}</td>
                                    </tr>
                                    <tr>
                        ...
                        <div class="footer-area">
                            <a href="{{ route('ebaskat.admin.order.invoice',$order->id) }}" class="mybtn1"><i class="fas fa-eye"></i> {{ __('View Invoice') }}</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
            ...
            <div class="row">
                                ...
                                @foreach($order->ebaskatMerchantPackages as $package)
                                    @foreach($package->orderProducts as $product)
                                        <tr>
                                            ...
                                            <td>
                                                <a target="_blank" href="{{route('admin.merchant.show',$package->merchant_id)}}">
                                                    {{$package->merchantInfo ? $package->merchantInfo->shop_name : NULL}}
                                                </a>
                                            </td>
                                            ...
                                            {{-- <td>€{{ number_format($product->product_quantity * $carts['price']?$carts['price']:$product->per_product_price,2, '.', '') }}</td> --}}
                ...
                <div class="col-lg-12 text-center mt-2">
                    <a class="btn sendEmail send mt-3" href="javascript:" class="send"
