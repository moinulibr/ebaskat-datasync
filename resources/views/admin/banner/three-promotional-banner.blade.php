...
@section('content')
    ...
    <div class="content-area">
        <div class="mr-breadcrumb">
            <div class="row">
                <div class="col-lg-5">
                    <h4 class="heading">{{ __('Three Promotional Banners') }}</h4>
                    <ul class="links">
                        <li>
                        ...
                        <li>
                            <a href="javascript:">{{ __('Three Promotional Banners') }}</a>
                        </li>
                    </ul>
                </div>
                <div class="col-lg-7">
                      ...
                      <div class="row">
                          <div class="col-md-12 mt-3">
                              <div class="btn-group float-right" role="group">
                                ...
                                <a href="{{ route('three-promotional-banner') }}" class="btn btn-info">Promotional 3 Banners</a>
    ...
    {{-- DELETE MODAL --}}
    @include('includes.delete-modal', ['type' => 'Three Promotional Banners'])
    {{-- Resote Modal --}}
    @include('includes.restore_modal', ['type' => 'Three Promotional Banners'])
...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        var table = $('#geniustable').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '{{ route('admin-sb-datatables','ThreePromotional') }}',
            columns: [
        ...
        $(function () {
            $(".btn-area").append('<div class="col-sm-4 table-contents">' +
                '<a class="add-btn" data-href="{{route('three-promotional-create-banner')}}" id="add-data" data-toggle="modal" data-target="#modal1">' +
