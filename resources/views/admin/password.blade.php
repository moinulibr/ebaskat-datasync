                        ...
                        <div class="body-area">
                            <form id="geniusform" action="{{ route('admin.password.update') }}" method="POST"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="password" class="input-field" name="currentPassword"
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="left-area">
                                            <h4 class="heading">{{ __('Confirm New Password') }} *</h4>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <input type="password" class="input-field" name="confirmNewPassword"
                                               placeholder="{{ __('Confirm New Password') }}" required="" value="">
                                    </div>
                                </div>
