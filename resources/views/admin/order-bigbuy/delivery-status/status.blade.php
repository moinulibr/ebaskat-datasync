        ...
        <div style="margin-bottom: 5% !important;margin-top:2%;border-bottom: 1px dashed hsl(0, 38%, 69%);">
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    ...
                    <input type="hidden" class="orderPackageStatusUpdate" value="{{ route('bigbuy.admin.order.package.status.update') }}">
                </div>
            </div>
        </div>
    {{---order package main delivery status update--}}
        ...
        <div style="border:1px solid rgb(226, 226, 226); padding:2%;margin-left:2%;margin-top:.20%;">
            ...
            <div class="row" style="margin-bottom: 0px;">
                ...
                <div class="col-lg-3">
                    ...
                    <input type="hidden" value="{{route('bigbuy.admin.order.product.status.update')}}" class="orderProductStatusUpdate">
                </div>
            </div>
        </div>
    @endforeach
