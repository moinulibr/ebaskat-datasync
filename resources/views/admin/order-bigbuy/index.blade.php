...
@section('content')
            ...
            <div class="row">
                <div class="col-lg-5">
                    ...
                    <ul class="links">
                        ...
                        <li>
                            <a href="{{ route('bigbuy.admin.order.index') }}">{{ __('Bigbuy Orders') }}</a>
                        </li>
                        <li>
                            <a href="{{ route('bigbuy.admin.order.index') }}">{{ __('All Bigbuy Orders') }}</a>
                        </li>
                    </ul>
                </div>
                <div class="col-md-1">
                ...
                <div class="col-lg-12">
                    <div class="mr-table allproduct">
                        ...
                        <div class="row" >
                            ...
                            <div class="col-md-4">
                                <label for="">Order Package/Bigbuy Number</label>
                                <input type="text" autocomplete="off" name="custom_search" class="form-control custom_search" placeholder="Order Package / Bigbuy Number" style="font-size: 12px">
                            </div>
                            <div class="col-lg-3">
    ...
    {{--Bigbuy Order Number Update MODAL --}}
        <div class="modal fade" id="bigbuyOrderNumberUpdate_modal" tabindex="-1" role="dialog" aria-labelledby="modal1" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
        
                    <div class="modal-header d-block text-center">
                        <h4 class="modal-title d-inline-block">{{ __('Update Bigbuy Order Number') }}</h4>
                    ...
                    <div class="modal-body">
                        <div style="margin-bottom:10px;">
                            <p class="text-center">
                                <strong  style="border-bottom:1px solid gray;margin-bottom:10px;">Order Package Number : <span class="displayOrderPackageNumber"></span></strong>
                            </p>
                        </div>
                        ...
                        <div style="margin-left:10%;margin-right:10%;">
                            <label for="">Bigbuy Order No/Number</label>
                            <input type="hidden"  class="bigbuyOrderIdUpdateUrl" value="{{route('bigbuy.order.id.update')}}">
                            <input type="hidden" class="orderPackageTableId" value="">
                            <input type="number"  class="form-control bigbuyOrderId" value="" required>
                            <span class="bigbuyOrderIdErrorMessage" style="color:red;"></span>
                        </div>
                    </div>
                    ...
                    <div class="modal-footer justify-content-center">
                        ...
                        <a class="btn btn-primary updateBigbuyOrderNumberButton">{{ __('Update') }}</a>
                    </div>
        
                </div>
            </div>
        </div>
    {{--Bigbuy Order Number Update MODAL ENDS --}}
        ...
        <div class="modal fade" id="confirmation_place_single_order_modal" tabindex="-1" role="dialog" aria-labelledby="modal1" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <!-- Modal body -->
                    <div class="modal-body">
                        <p class="text-center">{{ __('You are about to place the order to bigbuy') }}.</p>
                        <p class="text-center">{{ __('Do you want to proceed?') }}</p>
                        <div class="loading" style="text-align: center;padding-bottom:20px;display:none;">
                            <strong style="color:#57837c;">
                                Processing...
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <p class="text-center">{{ __('You are about to syncing all selected order from bigbuy ') }}.</p>
                        <p class="text-center">{{ __('Do you want to proceed?') }}</p>
                        <div class="custom-control custom-switch" style="text-align: center;">
                            <div style="background-color:#101638;color:#fff;padding-bottom: 5px;padding-top: 3px;margin-left: -30px">
                    ...
                    <div class="modal-footer justify-content-center">
                        <button type="button" class="btn btn-default" data-dismiss="modal">{{ __('Cancel') }}</button>
                        <a class="btn btn-primary btn-submit confirm-syning-button">{{ __('Confirm Syncing') }}</a>
                    </div>
                    <input type="hidden" value="{{route('bigbuy.admin.order.package.status.update.by.syncing.bulking')}}" class="orderPackageStatusUpdateBySyncingBulking">
                </div>
            </div>
        </div>
    ...
    <!---display all product list of a single order for single single order place---->
    <div class="modal fade" id="displayAllProductForSingleOrderPlaceInThisModal" tabindex="-1" role="dialog" aria-labelledby="modal1" aria-hidden="true"></div>
    <!---display all product list of a single order for single single order place---->
    <!--------single single order place , confirmation modal-------------->
    <div class="modal fade" id="confirmationModalWhenSingleProductWiseOrderPlaceToBigby" tabindex="-1" role="dialog" aria-labelledby="modal1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content" style="background-color:#f5f0f0">
                ...
                <div class="modal-footer justify-content-center">
                    <button type="button" class="btn btn-danger" data-dismiss="modal">{{ __('Cancel') }}</button>
                    <input type="hidden" class="singleSingleOrderId">
                    <a class="btn btn-primary singleSingleOrderConfirmationButton">{{ __('Confirm Order') }}</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <!--Bigbuy Order Number Update MODAL ENDS -->
    <div class="modal fade" id="bigbuyOrderNumberUpdateForSingleOrder_modal" tabindex="-1" role="dialog" aria-labelledby="modal1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content"  style="background-color:#f5f0f0">
                ...
                <div class="modal-body">
                    <div style="margin-bottom:10px;">
                        <p class="text-center">
                            <strong  style="border-bottom:1px solid gray;margin-bottom:10px;">
                                Product :
                            </strong>
                        <span class="displayOrderProductNameForSingleOrder"></span>
                        </p>
                    </div>
                    ...
                    <div style="margin-left:10%;margin-right:10%;">
                        <label for="">Bigbuy Order No/Number</label>
                        <input type="hidden"  class="bigbuyOrderNoUpdateUrlForSingleOrder" value="{{route('bigbuy.order.no.update.for.single.order')}}">
                        <input type="hidden" class="orderProductTableIdForSingleOrder" value="">
                        <input type="number"  class="form-control bigbuyOrderNoForSingleOrder" value="" required>
                        <span class="bigbuyOrderIdErrorMessageForSingleOrder" style="color:red;"></span>
                    </div>
                </div>
                ...
                <div class="modal-footer justify-content-center">
                    <button type="button" class="btn btn-danger" data-dismiss="modal">{{ __('Cancel') }}</button>
                    <input type="hidden" class="singleOrderPlaceRouteWithIdForSingleOrder">
                    <a class="btn btn-primary updateBigbuyOrderNumberButtonForSingleOrder">{{ __('Update') }}</a>
                </div>
    ...
    <input type="hidden" value="{{route('bigbuy.admin.order.list.by.ajax')}}" class="orderListByAjax" />
    <input type="hidden" value="{{route('bigbuy.admin.bulk.order.to.bigbuy')}}" class="bulkOrderPlaceToBigbuy" />
@endsection
...
<script>
    ...
    <script src="{{asset('custom_js/order/bigbuy-order/bigbuy_order_list.js')}}"></script>
    <script src="{{asset('custom_js/order/bigbuy-order/bigbuy_single_single_order.js')}}"></script>
@endsection
