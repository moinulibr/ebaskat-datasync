									...
									{{ Session::has('cart') ? count(Session::get('cart')->items) : '0' }}
															...
															<div class="product-details">
																<div class="content">
																	...
																	<span class="cart-product-info">
																		...
																		x <span id="prct{{$product['item']['id'].$product['size'].$product['color'].str_replace(str_split(' ,'),'',$product['values'])}}">{{ $product['item_price'] }}</span>
																	</span>
																</div>
												...
												<div class="dropdown-cart-total">
														...
														<span class="cart-total-price">
															<span class="cart-total">{{ Session::has('cart') ? (Session::get('cart')->totalPrice) : '0.00' }}
															</span>
														</span>
