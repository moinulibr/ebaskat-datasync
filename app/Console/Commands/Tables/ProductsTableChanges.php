...
class ProductsTableChanges
{
    public function __construct()
    {
        ...
        Schema::table($table_name, function (Blueprint $table) use ( $table_name, $indexs_list) {
            ...
            $indexs_col = ['user_id','category_id','subcategory_id','childcategory_id','brand_id','status','type','featured','top','latest','trending','sale','catalog_id'];
