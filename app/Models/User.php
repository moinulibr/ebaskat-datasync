...
class User extends Authenticatable implements JWTSubject
{
    ...
    protected $fillable = ['name', 'photo', 'zip', 'residency', 'city', 'country', 'address', 'phone', 'fax', 'email','password','affilate_code','verification_link','email_verified','shop_name','owner_name','shop_number','shop_address','reg_number','shop_message','is_vendor','shop_details','shop_image','f_url','g_url','t_url','l_url','f_check','g_check','t_check','l_check','shipping_cost','date','mail_sent','coupon_apply'];
    ...
    {
        return $this->hasMany('App\Models\VendorInformation','user_id');
    }
